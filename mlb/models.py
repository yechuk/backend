...
class MLBApiFa2022Analysis(models.Model):
    ...
    m2_contract_team_millions = models.DecimalField(max_digits=8, decimal_places=2, null=True, blank=True)
    m2_max_millions = models.DecimalField(max_digits=8, decimal_places=2, null=True, blank=True)
    m2_max_team = models.CharField(max_length=10, blank=True)
    m2_min_millions = models.DecimalField(max_digits=8, decimal_places=2, null=True, blank=True)
    m2_min_team = models.CharField(max_length=10, blank=True)
    team_specificity_level = models.CharField(max_length=32, blank=True)
    team_specificity_dollar_per_war = models.DecimalField(max_digits=6, decimal_places=2, null=True, blank=True)
    m2_by_team = models.JSONField(null=True, blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
